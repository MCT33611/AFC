...
const TestimonialSlider = () => {
  ...
  return (
    <div
      id="testimonial"
      className="max-w-full min-h-[75vh] flex items-center px-[10%] bg-green-50 mx-auto py-8 relative"
    ...
    >
        ...
        <div className="p-6">
          <div className="flex items-center mb-4">
            <img
              ...
              className="w-16 h-16 rounded-full mr-4 border-4 border-green-600"
            />
          ...
          {testimonials[currentSlide].description.length > 250 && (
            <button
              ...
              className="text-green-600 hover:underline mt-2 focus:outline-none"
            >
      ...
      <button
        onClick={handlePrev}
        className="absolute top-1/2 left-20 md:block hidden transform -translate-y-1/2 bg-green-600 text-white p-2 rounded-full shadow-md hover:bg-green-700 focus:outline-none"
      ...
      <button
        onClick={handleNext}
        className="absolute top-1/2 right-20 md:block hidden transform -translate-y-1/2 bg-green-600 text-white p-2 rounded-full shadow-md hover:bg-green-700 focus:outline-none"
